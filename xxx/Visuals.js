...
documentation.operations.push({
    ...
    async: false,
    returns: 'Node',
    description: 'Creates an HTML bar chart node based on a Data Frame containing data. A bar chart can contain multiple values. Alternatively, if a single measure is provided, an optional sub-group can be specified.',
    signatures: [
        [
            {
                parameterName: 'data',
            ...
            },
            {
                ...
                parameterDescription: 'The column name used for the bar chart categories (x-axis).'
            },
            {
                parameterName: 'valueName',
                parameterType: 'string',
                parameterDescription: 'The column name used for the bar chart values (y-axis).'
            }
        ]
    ],
    examples: [
...
Visuals.bar = function (data, options) {
    ...
    if (options.fnCategories) {
        categoryName = Object.getOwnPropertyNames(options.fnCategories(data.head(1)))[0];
    }
    let subGroups = [];
    ...
    if (options.fnSubGroups) {
        ...
        let subGroupName = Object.getOwnPropertyNames(options.fnSubGroups(data.head(1)))[0];
        subGroups = data.map(row => options.fnSubGroups(row)).column(subGroupName).distinct();
        let valueName = Object.getOwnPropertyNames(options.fnValues(data.head(1)))[0];
        data = data.pivot(
        ...
        subGroups = Object.getOwnPropertyNames(options.fnValues(data.head(1)));
        data = data.group(
            options.fnCategories,
            options.fnValues
        );
    ...
    let maxValue = 0;
    subGroups.forEach(g => {
        let value = d3.max(data, function (d) { return +d[g] });
        if (value > maxValue) {
            maxValue = value;
        }
    });
    ...
    svg.selectAll("mybar")
        ...
        .append("g")
        .attr("transform", function (d) { return "translate(" + x(d[categoryName]) + ",0)"; })
        .selectAll("rect")
...
documentation.operations.push({
    ...
    async: false,
    returns: 'Node',
    description: 'Creates an HTML table node based on a Data Frame containing data.',
    signatures: [
        [
            {
                parameterName: 'data',
...
documentation.operations.push({
    ...
    async: false,
    returns: 'Node',
    description: 'Creates an HTML pie chart node based on a Data Frame containing data.',
    signatures: [
        [
            {
                parameterName: 'data',
            ...
            },
            {
                parameterName: 'categoryName',
                parameterType: 'string',
                parameterDescription: 'The column name used for the pie segment categories.'
            },
            {
                parameterName: 'valueName',
                parameterType: 'string',
...
documentation.operations.push({
    ...
    async: false,
    returns: 'Node',
    description: 'Creates an HTML histogram chart node based on a Data Frame containing data.',
    signatures: [
        [
            {
                parameterName: 'data',
            ...
            },
            {
                ...
                parameterType: 'string',
                parameterDescription: 'The name of the column to draw a histogram for. The column should be a numeric column.'
            }
        ]
    ],
    examples: [
...
Visuals.hist = function (data, columnName) {
    ...
    let minValue = d3.min(data, function (d) { return +d[columnName] });
    let maxValue = d3.max(data, function (d) { return +d[columnName] });
    ...
    var histogram = d3.histogram()
        .value(function (d) { return d[columnName]; })   // I need to give the vector of value
...
documentation.operations.push({
    ...
    async: false,
    returns: 'Node',
    description: 'Creates an HTML scatter chart node based on a Data Frame containing data.',
    signatures: [
        [
            {
                parameterName: 'data',
            ...
            },
            {
                ...
                parameterType: 'string',
                parameterDescription: 'The name of the column to place on the x-axis of the scatter plot. The column should be a numeric column.'
            },
            {
                parameterName: 'yColumnName',
                parameterType: 'string',
                parameterDescription: 'The name of the column to place on the y-axis of the scatter plot. The column should be a numeric column.'
            },
            {
...
Visuals.scatter = function (data, xColumnName, yColumnName, options) {
    ...
    // Add X axis
    let minXValue = d3.min(data, function (d) { return +d[xColumnName] });
    let maxXValue = d3.max(data, function (d) { return +d[xColumnName] });
    var x = d3.scaleLinear()
    ...
    // Add Y axis
    let minYValue = d3.min(data, function (d) { return +d[yColumnName] });
    let maxYValue = d3.max(data, function (d) { return +d[yColumnName] });
    var y = d3.scaleLinear()
...
documentation.operations.push({
    ...
    async: false,
    returns: 'Node',
    description: 'Creates an HTML boxplot diagram for a column of numeric values.',
    signatures: [
        [
            {
                parameterName: 'data',
...
documentation.operations.push({
    ...
    async: false,
    returns: 'Node',
    description: 'Creates scatterplot matrix showing relationship between numerical variables in a DataFrame object.',
    signatures: [
        [
            {
                parameterName: 'data',
